...
export class Avatar extends RkComponent {
  ...
  renderImg(styles) {
    ...
    console.log('renderImg',typeof this.props.img);
    return (
      <View>
        {typeof this.props.img=='object'?(  <Image style={image} source={this.props.img}/>):(  <Image style={image} source={{uri: this.props.img.toString()}}/>)}
